var stands = {
	...
	_6: {
		...
		filter: (pointPerSec) => {
			...
			else { return pointPerSec.times(-0.7); }
		},
	},
...
var ghost = [
...

	{
		...
		start: () => {
			...
			app.logTxt.splice(0, 0, "古神：我要打个广告，挖掘机学校哪家强，中国山东找蓝翔，近百台世界各地先进设备供学员实习，试学一月不收任何费用，山东蓝翔高级技工学校!");
...

	{
		...
		start: () => {
			...
			app.logTxt.splice(0, 0, "古神感觉到你威胁到了祂。");
...
var god = [
...

	{
		...
		start: () => {
			...
			app.logTxt.splice(0, 0, "上玄真尊：古神？哈哈我昨天和祂下棋我赢了");
